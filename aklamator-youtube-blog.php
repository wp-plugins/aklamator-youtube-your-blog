...
if( !function_exists("aklamatorYT_plugin_settings_link")){
    ...
    function aklamatorYT_plugin_settings_link($links) {
        $settings_link = '<a href="admin.php?page=aklamator-youtube-blog">Settings</a>';
...
class AklamatorYoutubeWidget
{
    ...
    {
        add_menu_page('Aklamator - Youtube Your Blog', 'Aklamator YT', 'manage_options', 'aklamator-youtube-blog', array(
            $this,
            'createAdminPage'
        ), content_url() . '/plugins/aklamator-youtube-blog/images/aklamator-icon.png');
    ...
    <?php endif; ?>
        ...
        <script type="text/javascript" src="<?php echo content_url(); ?>/plugins/aklamator-youtube-blog/assets/dataTables/jquery.dataTables.min.js"></script>
...
class Aklamator_youtube_widget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <?php else :?>
            ...
            <a href="<?php echo admin_url(); ?>admin.php?page=aklamator-youtube-blog">Click here to configure Aklamator plugin</a>
            <br>
            <br>
        <?php endif;
